...
4. average_protein_length.py
 ...
 13. change_aa_props_degeneracy.py

 14. change_codon_props.py
     #will return the top n codons of type codtype whose proportions you should change (as a list)
     "IndexError: arguments are 1:filename(in nt_cod_aa_bias format), 2:codon type (1, 2, or 3), 3:number of codons (from top) that you want to change), 4: percent to change them by (exp: '90' will result in 10% decrease for those codons)"

 16. change_top_props.py
 ...
 19. codon_class_categorize_lcrs.py
 ...
 21. count_codon_types_all_cds.py
 ...
 22. generate_biologically_biased_proteome.py
 ...
 23. generate_random_proteome.py
 ...
 25. improved_codon_class_lcr_simulation.py
 ...
 27. inc_slip_sim_species_specific.py
 ...
 29. make_periodicity_entropy_plots.R
 ...
 31. making_scatter_correlation_plots.R
